...
class APITestCase(TestCase):
    ...
    def add_transcription_data(self):
        ...
        #add user here and also groups we need two users and one superuser
...
class APIItemListTestsOpenModels(APITestCase):
    base_url = '/api/{}/{}/'
...
class APIItemDetailTestsOpenModels(APITestCase):
    base_url = '/api/{}/{}/{}'
...
class APIItemListTestsRestrictedModels(APITestCase):
    base_url = '/api/{}/{}/'
...
class APIItemDetailTestsRestrictedModels(APITestCase):
    base_url = '/api/{}/{}/{}'
...
class APIItemListTestsRestrictedNoPublicField(APITestCase):
    base_url = '/api/{}/{}/'
    #NB: There is no model that conforms to being 'restricted' availability
    #and with no public field because that should never happen. So I will
    #temporarily make an open one with no public field into a restricted one
    #using setUp and tearDown (which is why this test is in its own class)

    def setUp(self):
        transcription_models.Work.AVAILABILITY = 'restricted'

    def tearDown(self):
        transcription_models.Work.AVAILABILITY = 'open'
...
class APIItemListTestsPrivateModels(APITestCase):
    base_url = '/api/{}/{}/'
    ...
    def tearDown(self):
        transcription_models.Transcription.AVAILABILITY = 'restricted'
...
class APIItemDetailTestsPrivateModels(APITestCase):
    base_url = '/api/{}/{}/{}'
    #I don't want the tests to be dependent on too many apps
    #As the transcription app is one of the requirements of most of the others
    #it would be good if tests were restricted to this app only.
